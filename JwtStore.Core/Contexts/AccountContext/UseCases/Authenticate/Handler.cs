    ...
    public class Handler : IRequestHandler<Request, Response>
    {
        ...
        public async Task<Response> Handle(Request request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                if (user == null)
                    return new Response("Email não encontrado", 404);
            }
            catch
            {
            ...
            #region 03 - Verificar se a senha é válida
            ...
            #region 04 - Validar se a conta foi verificada
            ...
            {
                return new Response("Não foi possível obter os dados do perfil", 400);
            }
